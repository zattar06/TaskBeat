...
class CreateCategoryBottomSheet(
    ...
    override fun onCreateView(
        ...
        val textInputLayoutCategoryName = view.findViewById<TextInputEditText>(R.id.textInputEditText_category_name)

        btnCreate.setOnClickListener {
            val name = textInputLayoutCategoryName.text.toString()
